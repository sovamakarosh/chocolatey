...
$packageArgs = @{
  ...
  fileType      = 'MSI'
  url           = 'https://download.eset.com/com/eset/apps/business/eea/windows/latest/eea_nt32.msi' # download url, HTTPS preferred
  url64bit      = 'https://download.eset.com/com/eset/apps/business/eea/windows/latest/eea_nt64.msi' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
  #file         = $fileLocation
